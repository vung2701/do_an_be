# Generated by Django 4.2.7 on 2024-04-07 09:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='author_user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('created_by_image', models.ImageField(blank=True, null=True, upload_to='user_profile')),
                ('last_modified', models.DateTimeField(default=django.utils.timezone.now)),
                ('likes', models.PositiveIntegerField(default=0)),
                ('comments', models.PositiveIntegerField(default=0)),
